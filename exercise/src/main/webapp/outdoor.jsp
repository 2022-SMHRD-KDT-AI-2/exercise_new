    ...
    <div class="park">
       ...
       <c:if test="${chalVo.memAddr1 eq vo.park_area}">
        <div class="card_boxs">
            <div class="cards">
                  <div class="text_box">
            <h2 class="name"><a href="#" id="park${vo.park_seq}Name"> ${vo.park_name}</a></p>
            <p class="description" id="park${vo.park_seq}Addr">주소: ${vo.park_addr}</p>
            <div class="heart">
                <div class="icon">
                    <svg class="heart-main" name="park${vo.park_seq}" viewBox="0 0 512 512" width="10" title="heart">
                     <path d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z" />
                </svg>
           <svg class="heart-background" viewBox="0 0 512 512" width="100" title="heart">
         <path d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z" />
