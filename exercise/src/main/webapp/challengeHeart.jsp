...
<head>
    ...
    <link rel="stylesheet" href="./css/challengeHeart.css">
    ...
    <div id="wrap">
        ...
        <div id="container">
            <section id="section_1">
                <ul class="video_1">
                   <li>
                        <iframe width="540" height="300" src="https://www.youtube.com/embed/gMaB-fG4u4g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <div class="s1_cont">
                            <ul class="text_box">
                                <li>제목 :</li> 
                                <li>채널명  :</li> 
                    ...
                    <li><iframe width="540" height="300" src="https://www.youtube.com/embed/gMaB-fG4u4g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <div class="s1_cont">
                            <ul class="text_box">
                                <li>제목 :</li> 
                                <li>채널명  :</li> 
