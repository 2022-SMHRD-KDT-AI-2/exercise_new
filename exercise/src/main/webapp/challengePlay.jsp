...
<head>
<meta charset="UTF-8">
<title>운동추천프로그램 재생페이지</title>
<link rel="stylesheet" href="./css/heart.css">
<link rel="stylesheet" href="./css/challengePlay.css">
...
<body>
    ...
    <div id="container">
        <section id="section_1">
            <ul class="video_1">
               <li>
                    <iframe width="885" height="500" src="https://www.youtube.com/embed/gMaB-fG4u4g" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    <div class="s1_cont">
                        <ul class="text_box">
                            <li>제목 :</li> 
                         </ul>
                         <ul class="text_2">
                             <li> <div class="icon">
                                <svg class="heart-main" viewBox="0 0 312 312" width="10" title="heart">
                                 <path d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z" />
                            </svg>
                       <svg class="heart-background" viewBox="0 0 312 312" width="100" title="heart">
                     <path d="M462.3 62.6C407.5 15.9 326 24.3 275.7 76.2L256 96.5l-19.7-20.3C186.1 24.3 104.5 15.9 49.7 62.6c-62.8 53.6-66.1 149.8-9.9 207.9l193.5 199.8c12.5 12.9 32.8 12.9 45.3 0l193.5-199.8c56.3-58.1 53-154.3-9.8-207.9z" />
                    </svg>
                        </div></li>
                         </ul>
